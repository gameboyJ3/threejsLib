(function (global, factory) {
	...
	function Reticle ( color = 0xffc926, autoSelect = true, dwellTime = 1500 ) {
	...
	Widget.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
	    ...
	    createFullscreenButton: function () {
			...
			//console.log("createFullscreenButton----------222");
	        return item;
	...
	Viewer.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
	    ...
	    addReticle: function () {
	        ...
	        this.reticle = new Reticle( 0xffc926, true, this.options.dwellTime );
	        this.reticle.hide();
